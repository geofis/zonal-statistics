...
> Si quieres consultar el código con el que generé los archivos resultantes del *spatial binning*, visita [esta](#cloud-processing-and-r) sección.
...
# Cloud processing (GEE) and post-processing in R{#cloud-processing-and-r}
